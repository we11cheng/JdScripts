...
!(async() => {
  ...
  console.log = (...args) => {
    ...
    if (args[0].includes('签到用时')){
      ...
      if ($.isNode() && notifyContent.length != 0 && jdNotify!= 0 ) {
...
async function download() {
  return new Promise(resolve => {
    const options = { 'url':'https://ghproxy.com/https://raw.githubusercontent.com/NobyDa/Script/master/JD-DailyBonus/JD_DailyBonus.js', "timeout": 10000 };
