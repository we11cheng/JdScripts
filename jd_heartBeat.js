/*
1111点心动
活动入口：京东-京东众筹-1111点心动
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
===============Quantumultx===============
[task_local]
#1111点心动
40 16,21 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_wish.js, tag=1111点心动, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "40 16,21 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_wish.js,tag=1111点心动

===============Surge=================
1111点心动 = type=cron,cronexp="40 16,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_wish.js

============小火箭=========
1111点心动 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_wish.js, cronexpr="40 16,21 * * *", timeout=3600, enable=true
 */
const $ = new Env('1111点心动');
...
let appIdArr = ['1FFVQyqw'];
let appNameArr = ['1111点心动'];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
