...
//
//export SHOP_TEST="${MyShopToken1}&${MyShopToken2}&${MyShopToken3}&${MyShopToken4}&${MyShopToken5}&${MyShopToken6}&${MyShopToken7}&${MyShopToken8}&${MyShopToken9}"
//方式二
//export SHOP_TEST="30DE3F2E8B4278A120007C8CD0D4F835&3C0B9CE1F01623C77ADE9F90AFA0FD5F&4A02128626C3691B6A98341C3F8CD27E&81F530105DFF92EF55FF36F1E2097066&9B45653CFEFE49045C2748E8AA9E37B4&B8157420EE77DDA819C2B3BAF991797B&BB80E573A5329D6AD511900955F6E12C&DCD2E2F3BECE2344E21ABB33D071BFAE&F9C7E6B7E724B7DB0CE232508C97490D"
...
if ($.isNode()) {
  ...
  let otherToken = [];
  if (process.env.SHOP_TEST) {
    console.log(process.env.SHOP_TEST)
    if (process.env.SHOP_TEST.indexOf('&') > -1) {
      console.log(`您的店铺 token 选择的是用&隔开\n`)
      otherToken = process.env.SHOP_TEST.split('&');
    } else if (process.env.SHOP_TEST.indexOf('\n') > -1) {
